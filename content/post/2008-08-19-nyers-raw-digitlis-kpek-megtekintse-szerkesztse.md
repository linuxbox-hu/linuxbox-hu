...
description: 'Ez idáig nem nagyon sikerült nyers képeimet gyorsan megnézni Linux alatt, mert: - vagy csak az icipici előnézeti képet mutatta a program (igaz gyorsan) - vagy konvertálni kellett a képet, ami viszonylag időigényes feladat Kicsit körbenézve az alábbiakat találtam (a leggyorsabb legelől):'
