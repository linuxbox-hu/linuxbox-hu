...
description: 'Egy mentési módszer: pg_dump -c -d -f backup_file.dmp -F p -O dbnev Lehet egyszerre tömöríteni is: pg_dump -c -d -F p -O dbnev | bzip2 > dbmentes.dmp.bz2'
