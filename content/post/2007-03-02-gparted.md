...
description: Szeretném bemutatni a kedvenc segédprogramon. Ez nem más, mint a Gparted (Gnome Partition Editor), mely elérhető a http://gparted.sourceforge.net web címen. Azért lett a kedvencem, mert tud magyarul (bár nem tökéletesen) és létezik liveCD változatban. (Sajnos az új liveCD-n már nem olyan szép a boot menü mint a korábbi verziókban.) Tökéletes alternatívája a fizetős PQmagic-nek. Rengeteg fájlrendszerrel képes dolgozni.
title: Gparted
aliases:
- /blog/326/
- /node/326/
