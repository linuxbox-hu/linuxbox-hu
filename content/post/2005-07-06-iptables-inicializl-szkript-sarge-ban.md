...
description: Aki woodyban jól ismerte az iptables csomagot, talán használta a /etc/init.d/iptables inicializáló szkriptet. Ezzel a szkripttel lehetett elmenteni különböző firewall beállításokat és autómatikusan visszaállítani őket pl. induláskor. Ez a szkript eltűnt a sargeból. Azért vette ki a csomagból a készítője ezeket a szkripteket, mert nem lehetett vele mindent jól kezelni. A csomag README állományában megtalálhatjuk, hogy mit ajánl a készítő a szkript kiváltására.
