...
description: Még régebben keresgéltem olyan programot linuxra mint a Yahoo Widgets vindózra. Rátaláltam a Screenlets-re. Innen tölthető le az alapprogi. A hivatalos oldalon sokféle kütyüt lehet letölteni (pölö. elemtöltöttség jelző, időjárás jelentő, naptár, keresők, stb.) Találtam egy olyan kütyüt, ami a hátteredet alakítja egy működő órára. Innen tölthető le a screenlet.
