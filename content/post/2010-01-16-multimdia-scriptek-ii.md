...
description: 'Jöjjön a következő: svg2png. Inkscape-t használ parancsmódban meghívva, zenity felületen paraméterezhető, exportált terület és a kimeneti felbontás állítható. A kód: #!/bin/bash ################################################# #\tWHAT is svg2png ? # Script to convert svg files to png # svg2png does not modify the file which you select, it creates a new file.'
