...
description: Az alábbi szkript egy függvényt tartalmaz, amivel lehetőségünk van **bash** alatt a zsh-tól olyannyira irigyelt színes tab completion-t szimulálni.
tags:
- bash
- zsh
- color
