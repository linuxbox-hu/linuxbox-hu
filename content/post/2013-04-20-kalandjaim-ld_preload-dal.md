...
description: Ebben a bejegyzésemben egy apró de annál hasznosabb hack-et mutatok be.
tags:
- x2vnc
- ssize_t
- LD_PRELOAD
...
Így tettem én is az [x2vnc](http://en.wikipedia.org/wiki/X2vnc) program esetében.
