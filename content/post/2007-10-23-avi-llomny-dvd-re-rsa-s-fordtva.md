...
description: 'Ha egy AVI állományt DVD formátumra akarunk konvertálni a következő lépéseket érdemes követni: mencoder -o finalmovie.avi -noidx -oac copy -ovc copy dvd.avi ffmpeg -i finalmovie.avi -y -target ntsc-dvd -sameq -aspect 16:9 finalmovie.mpg dvdauthor --title -o dvd -f finalmovie.mpg dvdauthor -o dvd -T mkisofs -dvd-video -o dvd.iso dvd/ Ezután a DVD-t egy közönséges asztali lejátszóval is le kéne tudjuk játszani. Ellenkező irányba (dvd -> avi) konvertáláskor használható akár a HandBrake nevű alkalmazás is.'
