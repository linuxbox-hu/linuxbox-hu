...
description: 'Johnatan Carter oldalán talált cikk és hozzászólások alapján meglehetősen sok játékot fedezhetünk fel az ubuntu linux csomagok közt! (természetesen az universe repoból!) Lássuk csak a listát:'
title: Ubuntu játék csomagok
aliases:
- /node/294/
- /story/294/
---
Johnatan Carter oldalán talált [cikk](http://jonathancarter.co.za/10-games-in-the-ubuntu-universe) és hozzászólások alapján meglehetősen sok játékot fedezhetünk fel az ubuntu linux csomagok közt! (természetesen az universe repoból!)
Lássuk csak a listát:
<!--break-->
1. Egy márió tipusú játék: supertux
   ![](/assets/img/posts/t_supertux.jpg)
