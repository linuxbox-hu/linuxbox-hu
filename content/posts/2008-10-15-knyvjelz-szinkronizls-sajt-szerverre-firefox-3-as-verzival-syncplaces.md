...
excerpt: '"Bookmark sort and sync" vagy "Google browser sync" és hasonló könyvjelző szinkronizálást szolgáltató kiegészítőket Firefox 2 használata köben könnyű volt megszokni és nehéz volt tőlük megválni mikor jött a Firefox 3. De most végre elkészült egy helyettesítő kiegészítő a syncplaces . A mozilla letöltési oldal még nem teljesen tökéletes, de plugin működik teszteltem.'
