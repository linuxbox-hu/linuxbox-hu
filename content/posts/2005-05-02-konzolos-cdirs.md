...
excerpt: 'Adat cd esetén: Készítsük elő az anyagot mksisofs-sel majd írjuk fel: mkisofs -l -R -J -o cd.img cdre/ cdrecord speed=16 dev=0,3,0 -eject -v a.iso avagy cdrdao write --speed 4 --device 0,3,0 --driver generic-mmc x.cue'
