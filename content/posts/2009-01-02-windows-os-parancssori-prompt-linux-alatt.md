...
excerpt: 'Fel lehet fogni poénnak is, de azt is el tudom képzelni hogy valaki ragaszkodik aa megszokotott c:\ -hez. :D export PS1=''C:${PWD//\//\\\}>'' A kódsor lecseréli a $PWD változóban (aktuális elérési út) linuxos /-t windowsos \-re így az eredmény: C:\home\ szerű prompt... Eredeti cikk.'
