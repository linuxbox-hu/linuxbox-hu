...
excerpt: 'hup-on találtam egy feljegyzésre méltó FF hekkelés blogot: Firefox gombok újratöltve cím alatt. A trükk mindössze annyi, hogy az alap CSS desinghoz hozzáad pár apró szépítést és pofás "flat" stílúsú gombokat és beviteli mezőket láthatunk ezáltal azon oldalakon is ahol ez nincs definiálva. A csatolmányt letöltve egyszerűen telepíthető a csomag a firefox res könyvtárába kitömörítve majd a cat forms-extra.css >> forms.css form definíció kiegészítéssel végül FF újra indátással már kész is. :)'
