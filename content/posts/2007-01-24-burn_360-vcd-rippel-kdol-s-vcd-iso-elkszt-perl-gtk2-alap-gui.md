...
excerpt: 'Burn 360 egy előlap alkalmazás három programhoz - ffmpeg, vcdimager és cdrdao. Ezen alkalmazásokat külön szálon is képes parhuzamosan működtetni: - video sávokat ment el VCD-ről - ffmpeggel kódol - és MPEG-ből CD-re írható VCD cdkép allományokat készít merevelemezre tgz és rpm csomag tölthető csak le. :('
