...
excerpt: 'Kicsomagolni tar állományt: tar -xvvf file.tar (hagyd el a -v vagy -vv kapcsolókat ha nem akarod követni az eseményket.) Megadott kövtárba kicsomagolás: tar -xvf file.tar -C /destination/dir/ Kitömöríteni tar.Z állományt: tar -xvZf file.tar.Z gzippelt állományt: tar -xvzf file.tar.gz'
